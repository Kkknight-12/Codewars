...
let book = "1000.00 125 Market 125.45 126 Hardware 34.95 127 Video 7.45 128 Book 14.32 129 Gasoline 16.10"

function balance(book) {
let originalBalance = /^[0-9\.]+/gm;
  let purchase = /[^0-9|\.|a-z|A-Z|][0-9|\.]*/gm;
  console.log(originalBalance.exec(book))
  console.log(purchase.exec(book))
  purchase = book.match(purchase);
